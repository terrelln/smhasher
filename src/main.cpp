...
HashInfo g_hashes[] =
{
  ...
  { XXH32_kernel_test,       32, 0xBA88B743, "xxh32-k",     "xxHash-kernel block mode 32-bit" },
  { XXH64_kernel_test,       64, 0x024B7CF4, "xxh64-k",     "xxHash-kernel block mode 64-bit" },
  { XXH32_stream_test,       32, 0xBA88B743, "xxh32-s",     "xxHash block mode 32-bit" },
  { XXH64_stream_test,       64, 0x024B7CF4, "xxh64-s",     "xxHash block mode 64-bit" },
  { XXH32_kernel_stream_test,32, 0xBA88B743, "xxh32-k-s",   "xxHash-kernel block mode 32-bit" },
  { XXH64_kernel_stream_test,64, 0x024B7CF4, "xxh64-k-s",   "xxHash-kernel block mode 64-bit" },
};
